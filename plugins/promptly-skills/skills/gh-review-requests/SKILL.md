...
```bash
uv run ${CLAUDE_SKILL_ROOT}/scripts/fetch_review_requests.py --org promptlylabs --teams <team-slug>
```

To filter by multiple teams, pass a comma-separated list:

```bash
uv run ${CLAUDE_SKILL_ROOT}/scripts/fetch_review_requests.py --org promptlylabs --teams <team slugs>
```
  ...
  "prs": [
    {
      ...
      "url": "https://github.com/promptlylabs/pdp-core/pull/42",
      "repo": "promptlylabs/pdp-core",
      "pr_number": 42,
      "author": "bmckerry",
...
| # | Title | URL | Reason |
|---|-------|-----|--------|
| 1 | feat(api): add patient enrollment endpoint | https://github.com/promptlylabs/pdp-core/pull/42 | opened by: dev |
