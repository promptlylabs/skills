...
1. Local canonical workflow source (`plugins/promptly-skills/skills/skill-writer/...`).
2. Local compatibility alias/source (`plugins/promptly-skills/skills/skill-creator/SKILL.md`).
